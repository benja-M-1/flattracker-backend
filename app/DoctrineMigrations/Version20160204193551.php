 ...
 */
class Version20160204193551 extends AbstractMigration
{
    /**
     * @param Schema $schema
     */
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE SEQUENCE ft_user_id_seq INCREMENT BY 1 MINVALUE 1 START 1');
        $this->addSql('CREATE TABLE ft_user (id INT NOT NULL, email VARCHAR(255) NOT NULL, facebook_id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id))');
        ...
        $this->addSql('CREATE TABLE ft_visit (id INT NOT NULL, searcher_id INT DEFAULT NULL, tracker_id INT DEFAULT NULL, url VARCHAR(511) NOT NULL, PRIMARY KEY(id))');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('DROP SEQUENCE ft_user_id_seq CASCADE');
